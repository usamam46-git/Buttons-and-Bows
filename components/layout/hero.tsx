...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // Staggered circle entrances with bounce and random opacity
    ...
    // Second line slide up, overlapping slightly
    tl.fromTo(
    ...
    // "Love" word elastic bounce with rotation
    tl.fromTo(
      loveSpanRef.current,
    ...
    <section className="w-full min-h-screen flex items-center justify-center bg-[#FEFBEA] px-6 py-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          {/* Added h-auto to ensure padding doesn't conflict with default button height */}
          ...
          <div className="mt-8 flex items-center gap-4 text-gray-600">
            ...
            <img src="/logo.jpg" className="w-[220px] mix-blend-multiply" />
          </div>
        </div>

        {/* Right Side Image + Circles */}
        <div className="relative flex justify-center items-center">
          {/* Changed to rounded-full, added explicit height and object-cover */}
          <img
            ref={imageRef}
            src="/hero2.jpg"
            alt="child"
